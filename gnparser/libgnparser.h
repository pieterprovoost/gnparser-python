...
// true.
//
extern char* ParseToString(char* name, char* fmtStr, char* codeStr, int details, int diaereses);
...
// true.
//
extern char* ParseAryToString(char** in, int length, char* fmtStr, char* codeStr, int details, int diaereses);
